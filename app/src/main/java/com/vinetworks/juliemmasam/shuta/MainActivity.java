...
public class MainActivity extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position){
            ...
            switch (position){
                case 0:
                    return getBaseContext().getString(R.string.profile_tab);

                case 1:
                    return getBaseContext().getString(R.string.courses_tab);

                case 2:
                    return getBaseContext().getString(R.string.grades_tab);
